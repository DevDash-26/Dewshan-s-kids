...
export interface ApiContentItemContentItem extends Struct.CollectionTypeSchema {
  ...
  info: {
    description: 'Unified reusable content engine covering campus information categories (announcements, events, societies, calendar, support resources, etc.).';
  ...
  attributes: {
    audience: Schema.Attribute.Enumeration<
      ['EVERYONE', 'FACULTY', 'PROGRAMME', 'YEAR_GROUP']
    > &
      Schema.Attribute.Required &
    ...
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    createdBy_display: Schema.Attribute.String;
    ...
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    yearGroup: Schema.Attribute.Integer;
  };
}
